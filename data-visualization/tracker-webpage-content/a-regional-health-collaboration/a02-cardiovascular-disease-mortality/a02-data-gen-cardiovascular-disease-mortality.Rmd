...
data_equity_tracts <- merge(cardio_mort_06_10, equity_tracts_10,
                            by.x="Census.Tract",
                            by.y="geoid", 
                            all.x=TRUE)
...
# join WTN data to equity quintiles (on 2010 census tracts)
data_equity_tracts <- merge(cardio_mort_11_15, equity_tracts_15,
                            by.x="Census.Tract",
                            by.y="geoid", 
                            all.x=TRUE)
...
data_crosswalk <- merge(crosswalk_10_20, cardio_mort_16_20,
                        by.x="geoid10",
                        by.y="Census.Tract",
                        all.x=TRUE)
...
nrow(data_equity_pivot20) #11052
```
...
data_clean <- data_clean %>%
  dplyr::mutate(estimate=as.numeric(cardio_rate)) #rename value variable for consistency
