...
# set up palettes
psrc_purple_plus<-c("#FFFFFF","#FAE6FA","#F6CEFC", psrc_colors$purples_inc,"#6F456E")
psrc_purple_new<-psrc_purple_plus[!(psrc_purple_plus %in% c("#91268F"))]
...
psrc_palette <- leaflet::colorNumeric(palette = psrc_purple_new,
