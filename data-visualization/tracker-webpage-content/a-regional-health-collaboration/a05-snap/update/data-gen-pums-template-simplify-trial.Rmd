...
file_names <- list(base_dir = 'Y:/Equity Indicators/tracker-webpage-content',
                   ...
                   ind_dir = 'a-regional-health-collaboration',
                   chart = 'a05-snap',
...
check_missing_data <- function(vars, multiply_by_subgroups = FALSE) {
  ...
  # option to multiply by number of subgroups
  ...
  expected_val <- if(vars[2]=="num_county") 5 
  else if(vars[2]=="num_group") 6
  else if(vars[2]=="num_sub_group") 6
  
  # if(vars[2]=="num_county"){
  #   expected_val==5}
  # else if(vars[2]=="num_group"){
  #   expected_val==6}
  # else if(vars[2]=="num_sub_group"){
  #   expected_val==6
  # }
...
# result_message <- function(var, expected_val, output){
#   
#   expected_val <- data_fields_summary[[var]]$length*expected_val
#   actual_val <- output
#   
#   if(expected_val < actual_val){
#     warning(paste("There are", actual_val, "rows, which is fewer than expected. Please check."))
#   } else if (expected_val > actual_val){
#     warning(paste("There are", actual_val, "rows, which is more than expected. Please check."))
#   } else {
#     message(paste("There are the expected number of rows in the dataset:", actual_val))
#   }
#   
# }
```
...
# result_message("num_yr", 5, num_yr_geo)
```
...
# result_message("num_yr", 6, num_yr_grp)
```
...
# data_clean <- equity_tracker_label_formatting(data_full)
