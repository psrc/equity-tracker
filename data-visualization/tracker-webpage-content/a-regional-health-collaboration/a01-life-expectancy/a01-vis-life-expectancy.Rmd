...
labels <- sprintf(
  ...
  paste("County value: ", prettyNum((round(data_tract$cnty_estimate, digits=1))), " years")) %>% 
...
tract_map
```
Sources: Washington State Department of Health (DOH) 2017-21 Washington Tracking Network (WTN); U.S. Census Bureau, Geography Division 2020 TIGER/Line Shapefiles
