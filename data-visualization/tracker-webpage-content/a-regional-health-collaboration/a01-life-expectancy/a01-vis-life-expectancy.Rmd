...
Life expectancy provides a way to understand a population's overall health. Differences between groups of people can highlight differing access to healthcare and public services, adequate nutrition, and living conditions, all which impact a population's mortality rate. For this measure, we are defining life expectancy as a measure of the number of years a newborn can expect to live based on current age-specific death rates.
...
psrc_palette <- leaflet::colorNumeric(palette = psrc_purple_plus,
                                      domain = c(min(data_tract$estimate,na.rm = TRUE),max_value, NA))
...
source = paste("Washington State Department of Health, 2016-2020 Washington Tracking Network, Life Expectancy at Birth;", "U.S. Census Bureau, 2016-2020 American Community Survey 5-Year Estimates, Tables B02001, C17002, B22010, B11005, B11007, C16002", sep="\n")
...
source = "Source(s): Washington State Department of Health, 2006-2010, 2011-2015, 2016-2020 Washington Tracking Network, Life Expectancy at Birth; U.S. Census Bureau, 2006-2010, 2011-2015, 2016-2020 American Community Survey 5-Year Estimates, Tables B02001, C17002, B22010, B11005, B11007, C16002"
...
filter <- data_clean %>% 
  filter(county=="Region",
         ...
         data_year=="2015" |
           data_year=="2020") 
# 2015:low-high: 77.42494-77.69571=-0.27077
# 2020:low-high: 76.63036-78.46467=-1.83431
# ((-1.83431--0.27077)/(-0.27077))*100: 577.4421% change
# 1.83431-0.27077=1.56354
...
filter <- data_clean %>% 
  filter(county!="Region",
         ...
         quintile=="High")
# King 2020-2010: 77.63977	
# Pierce 2020-2010: 70.37597
# Snohomish 2020-2010: 80.50632
```
