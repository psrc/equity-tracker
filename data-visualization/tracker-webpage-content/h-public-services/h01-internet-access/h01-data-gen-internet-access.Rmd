...
acs_data_moes <- acs_data_calc %>%
  rowwise() %>%
  # mutate(moe_perc_own_occ=moe_prop(num=estimate_Owner_occupied_units,
  #                                  denom=estimate_Total_units, 
  #                                  moe_num=moe_Owner_occupied_units, 
  #                                  moe_denom=moe_Total_units)) %>% 
  mutate(moe_cost_burdened=tidycensus::moe_sum(estimate = estimate_with_internet,
