...
Note about the data, the rate has been adjusted to the natural log to make the scale manageable.
...
calc <- data %>%
  mutate(Log_rate=(sum(estimate*total_pop20, na.rm =TRUE))/(sum(total_pop20, na.rm=TRUE)))
...
#  0.000   3.776   4.546   4.274   5.302   8.988

sort <- data %>% 
  dplyr::arrange(desc(estimate))

# 2 highest: 53053061400 (downtown Tacoma that includes the jail) Pierce (8.99), 53033008500 (Yesler Terrace are of Seattle that includes Harborview) King (8.54), 53053060200 (Port of Tacoma area) Pierce (8.44), 53061040700 (downtown Everett which includes the Snohomish County jail) Snohomish (8.19)
...
by_county <- data %>% 
  ...
  dplyr::summarise(Log_rate=(sum(estimate*total_pop20, na.rm =TRUE))/(sum(total_pop20, na.rm=TRUE))) %>% 
  dplyr::arrange(desc(Log_rate))
# King (3.864659), Snohomish (4.415889), Kitsap (4.905620), Pierce (4.967245)
...
1. 4.27: The region's average imprisonment rate
2. 5.30: Washington State's average imprisonment rate
\
...
* Pierce County has the highest imprisonment rate (4.97), followed by Kitsap (4.91), Snohomish (4.42), and King (3.86)
* The census tracts with the highest imprisonment rate are Downtown Tacoma, Pierce County (8.99); Yesler Terrace area of Seattle, King County (8.54); Port of Tacoma area, Pierce County (8.44); Downtown Everett, Snohomish County (8.19)
...
num_colors = 5
color_rev = FALSE
title = "Imprisonment Rate per 100,000"
subtitle = "Adjusted to Natural Log of Rate"
...
# region low quintile poc households: 4.034064
# region high quintile poc households: 4.613270
# 4.613270-4.034064=0.579206

filter <- data_clean_column %>% 
  filter(quintile=="High",
         equity_group=="income_quintile")

# region high quintile low income households: 5.348792
# king high quintile low income households: 5.080369
# kitsap high quintile low income households: 5.901199
# pierce high quintile low income households: 5.904947
# snohomish high quintile low income households: 5.303626
# 5.904947-5.080369=0.824578
...
# region dif bt high/low quintiles for lep: 4.634724-4.022319=0.612405
...
# region dif bt high/low quintiles for income: 5.348792-2.882136=2.466656
# king dif bt high/low quintiles for income: 5.080369-2.306679=2.77369
# kitsap dif bt high/low quintiles for income: 5.901199-4.231375=1.669824
# pierce dif bt high/low quintiles for income: 5.904947-3.855332=2.049615
# snohomish dif bt high/low quintiles for income: 5.303626-3.713748=1.589878
...
# region dif bt high/low quintiles for disability: 5.260693-3.010260=2.250433
# king dif bt high/low quintiles for disability: 4.912824-2.659749=2.253075
# kitsap dif bt high/low quintiles for disability: 5.468296-3.715005=1.753291
# pierce dif bt high/low quintiles for disability: 5.547184-3.812307=1.734877
# snohomish dif bt high/low quintiles for disability: 5.137279-3.679690=1.457589
...
filter <- data_clean_column %>% 
  filter(county!="Region",
         ...
         quintile=="Low"|
           quintile=="High")
# king dif bt high/low quintiles for income: 4.712045-3.325475=1.38657
# kitsap dif bt high/low quintiles for income: 5.370220-3.534470=1.83575
# pierce dif bt high/low quintiles for income: 5.694798-4.385939=1.308859
# snohomish dif bt high/low quintiles for income: 4.389303-4.483414=-0.094111
...
* The county with the highest imprisonment rate for communities with the highest concentration of households with lower income is Pierce County (5.905), followed by Kitsap (5.901), Snohomish (5.30), King (5.08)
* King County has the largest gap in imprisonment rate for lower income households which may be a reflection of the higher median income
...
* The county with the highest imprisonment rate for communities with the highest concentration of households with disabilities is Pierce County (5.69), followed by Kitsap (5.37), King (4.71), Snohomish (4.38)
