...
file_names <- list(base_dir = 'Y:/Equity Indicators/tracker-webpage-content',
                   ...
                   map_name = 'h02-imprisonment-map.html',
                   column_chart_name = 'h02-imprisonment-column',
                   line_chart_name = 'h02-imprisonment-line')
...
# to save html visual to folder, you must create an 'webpage-html-outputs' folder within each indicator sub-folder: Y:\Equity Indicators\tracker-webpage-content\h-public-services\h02-imprisonment\webpage-html-outputs
...
# to save html visual to folder, there must be an 'webpage-html-outputs' folder within each indicator sub-folder: Y:\Equity Indicators\tracker-webpage-content\h-public-services\h02-imprisonment\webpage-html-outputs
