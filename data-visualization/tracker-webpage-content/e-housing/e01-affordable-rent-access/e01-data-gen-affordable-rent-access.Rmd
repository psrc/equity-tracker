...
# generate equity group data
poc_king <- county_function(data_clean_affordability_2021, simple_acs_data_2021, "King", "POC")
non_poc_king <- county_function(data_clean_affordability_2021, simple_acs_data_2021, "King", "Non-POC")
low_income_king <- county_function(data_clean_affordability_2021, simple_acs_data_2021, "King", "Low Income")
non_low_income_king <- county_function(data_clean_affordability_2021, simple_acs_data_2021, "King", "Non-Low Income")
