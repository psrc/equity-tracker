...
```{r}
# The following is commented out because the code chunks above generate the necessary data tables - the iteration-data.R script that is saved within the 'e01-affordable-rent-access' folder replicates the order of steps that get the two data inputs (Elmer median household income equity data and ACS tract-level median gross rent data) to this stage
