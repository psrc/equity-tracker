...
# getting median gross rent data by tract
base_acs_data <- get_acs_recs(geography ='tract', 
                              table.names = 'B25064',
                              years = c(2022),
                              acs.type = 'acs5')
