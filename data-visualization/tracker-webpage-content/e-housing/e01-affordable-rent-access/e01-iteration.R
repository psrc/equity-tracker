...
# setwd("C:\\Users\\mrichards\\Documents\\GitHub\\equity-tracker\\data-visualization\\tracker-webpage-content\\e-housing\\e01-affordable-rent-access\\")
# source("e01-iteration-data.R")

# the above code is commented out because the data that is required for this script to run is already in the e01-data-gen-affordable-rent-access.Rmd, so running source("e01-iteration-data.R") would just be pulling and transforming the data again
