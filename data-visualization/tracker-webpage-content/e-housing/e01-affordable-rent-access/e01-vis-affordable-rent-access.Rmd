...
2. 25%: Share of affordable tracts for renting households with limited English proficiency, a 63 percentage point difference compared to English-proficient renting households
3. 69%: Difference in the share of affordable tracts between renting households with older adults (2%) and other renting households (71%)
...
filter <- data_clean %>%
  filter(county=="Region",
         focus_type=="POC_cat",
         data_year!="2016")
# 2011 non-poc-poc: 0.8311856-0.7164948=0.1146908
# 2021: 0.6673889-0.4875406=0.1798483
...
# ((0.9046587-0.9587629)/(0.9587629))*100: -5.643126% change
...
1. 2%: The share of tracts with affordable rent decreased 2% for renters of color, twice as much as for white non-Hispanic renters between 2011 and 2021
2. 6%: Regional access to affordable rent decreased 6% for households in the region living below 200% of federal poverty between 2011 and 2021, from 10 census tracts to 0
