...
* The highest median gross rent in Pierce, Kitsap, and Snohomish County are:  and the Tulalip Reservation (\$775)
...
1. \$515: The difference in gross median rent for households that are below 200% of the poverty level and those above
2. \$300: Households with English proficiency pay an average of \$300 more than Non-English proficient households
3. \$200-\$300: Regional median gross rent for those with children is \$200-\$300 higher than those without

\

#### Insights & Analysis

* Snohomish County has the smallest difference in gross median rent payments between people of color and white non-Hispanic (\$4,100), while King County has the largest difference (\$19,400)
* For households living below 200% of the poverty level, the largest difference in gross median rent is in King County (\$1,700-\$2,300), followed by Kitsap (\$1,900-\$1,400), Snohomish (\$2,000-\$1,600), and Pierce (\$1,800-\$1,500)
...
1. \$500: In 2021, households in the region living below 200% of the poverty line paid an average of \$500 less than households above the 200% poverty line, a 150% larger gap than in 2011
...
* The difference in gross median rent for people with a disability compared to those living without remained relatively consistent in all counties (from 2016 to 2021), including King County
