...
var_name <- "Rent <br> Burden" # the <br> could be adjusted depending on the length/spacing of the name
#labels <- sprintf(
...
1. 6.8%: The region's average percentage of rent-cost burdened households
2. 12%: The highest percentage of rent-burdened households in a census tract
3. 1.6%: The lowest representation of rent-burdened households in the region

\

#### Insights & Analysis

* King County's census tract 53033032220 has the highest population in the region, and the highest percentage of rent-burdened households (\12%)
* The five census tracts tied with the highest representation of rent-burdened households are the Issaquah Highlands (\12%) and Hollywood (\10.7%) in King County, Clearview (\11%) in Snohomish County, and the Fort Lewis (\10.7%) and West Frederickson (\10.5%) in Pierce County
...
# set folder structure
file_name <- 'e02-housing-cost-burden'
...
1. 2.7: Households who are below 200% of the poverty level are 2.7 times more likely to be rent burdened than households who are above 200% of the poverty level
2. 60%: Non-English proficient households have higher risk of being rent burdened across the region, at 60% of households
3. 50%: Snohomish County narrows the gap between households with people with disabilities and households with older adults (65+ years old)
...
* King County has the highest gap between households with English proficiency and households with Limited English that are experiencing rent burden in the region (60% and 40%), versus other counties with smaller gaps (10%)
* Snohomish County narrows the gap between households with people with disabilities and households with older adults (65+ years old) from 20% to 10%, and narrows the gap for households with people of color to 0, compared to regional averages 
...
1. 1.5%: In 2021, the difference between households in the region who were below 200% of the poverty line and households above the 200% poverty line was 1.5%, which has remained consistent
...
3. 0%: Households with and without people living with disabilities across the region have no increased the gap across the past 5 years, but have either remained constant or narrowed the gap

\

#### Insights & Analysis

* In 2021, the difference between households in the region who were below 200% of the poverty line and households above the 200% poverty line was 1.5%, which has remained consistent, but the proportion of rent burdened households based on income increased by 166% from 2011
