...
var_name <- "Housing <br> Tenure (Percentage)" # the <br> could be adjusted depending on the length/spacing of the name
...
x<-rep(data$estimate,times=data$total_pop20)
 ...
 hist(df1$x)
# regional median homeownership rates: 53.70
...
1. 53.7%: The region's median for census tracts with homeownership
