...
author: "Meg Grzybowski, updated by Kristin Mitchell"
...
# merge to 2020 census tract spatial file
acs_data_tract <- merge(county.lyr, county_reg_data,
                  by.x="county_name",
                  by.y="county_name",
                  all.y=TRUE)
...
# county_overcrowding <- county_acs_data %>% 
#   dplyr::filter(variable=="S2201_C03_001",
#                 name!="Region") %>% 
#   dplyr::select(name, estimate) %>% 
#   dplyr::rename(overcrowding=estimate)
# county_pop <- county_acs_data %>% 
#   dplyr::filter(variable=="S2201_C01_001",
#                 name!="Region") %>% 
#   dplyr::select(name, estimate) %>% 
#   dplyr::rename(pop_overcrowding=estimate)

# county_merge <- merge(county_overcrowding, county_pop,
#                       by.x="name",
#                       by.y="name",
#                       all.x=TRUE)
# county_data_simp <- county_merge %>% 
#   dplyr::mutate(cnty_estimate=overcrowding/pop_overcrowding) %>% 
...
# reg_overcrowding <- county_acs_data %>% 
#   dplyr::filter(variable=="S2201_C03_001",
#                 name=="Region") %>% 
#   dplyr::select(name, estimate) %>% 
#   dplyr::rename(overcrowding=estimate)
...
#   dplyr::rename(pop_overcrowding=estimate)
# 
# reg_merge <- merge(reg_overcrowding, reg_pop,
#                       by.x="name",
#                       by.y="name",
#                       all.x=TRUE)
# reg_data <- reg_merge %>% 
#   dplyr::mutate(reg_estimate=overcrowding/pop_overcrowding) %>% 
