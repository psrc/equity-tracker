...
pums_data_plus_zero<-append(pums_data_county$estimate,0)

psrc_palette <- leaflet::colorNumeric(palette = psrc_purple_plus,
                                      domain = pums_data_plus_zero) # this is the value field
...
labels <- sprintf(
  ...
  paste(pums_data_county$county_name, " County"), # the code in <> makes the geoid value bold/italic
  paste("County value: ",
        prettyNum(round(pums_data_county$estimate, digits=1)), 
        '%'),
  paste("County data reliability: ", pums_data_county$reliability),
  paste("Region value: ",
        prettyNum(round(pums_data_county$reg_estimate, digits=1)),
        '%')) %>%
...
acs_map <- leaflet() %>%
  ...
  leaflet::addProviderTiles("CartoDB.VoyagerOnlyLabels",
                            ...
                            group = "Labels") %>%
  addPolygons(data=pums_data_county,
              fillColor = psrc_palette(pums_data_county$estimate),
              stroke=FALSE, 
              smoothFactor = 0.2,
              fillOpacity = 0.7,
              group = var_name,
...
1. 21.5%: The regional average of overcrowded renting households
2. 23.3%: King County has the highest rate of overcrowding renting households
3. 14.5%: Average percentage of households in Kitsap County, the county with the lowest overcrowding rates

\

#### Insights & Analysis

* King County has the highest rates of overcrowding among renters (23%), followed by Snohomish (20%), Pierce (19%), and Kitsap (15%)
...
* Compared to King County, Kitsap County's overcrowding rate among renters is about two-thirds19 as high, while Pierce is about four-fifths as high
...
1. 12: Among renting households in the region, the overcrowding rate for people of color is 12 percentage points higher than white non-Hispanic households
2. 26%: Over one-quarter of the region's households below 200% of federal poverty line that are experiencing overcrowding
3. 36%: Percentage of limited English proficient households experiencing overcrowding, 16 percentage points higher than than English proficient households
...
* The largest difference in overcrowding rates between people of color and white non-Hispanic is in King County (14 percentage points), while the smallest difference is in Kitsap and Pierce (8 percentage points)
* King County has the highest rate of overcrowding among renting households below 200% of federal poverty (28%), followed by Snohomish (25%), Pierce (24%), and Kitsap (18%) 
* Households with children (below 18 years old) and households with limited English proficient speakers have the highest rates of overcrowding across all of the demographic groups, regardless of county (between one-quarter and one-third).
...
filter <- data_clean %>%
  filter(county=="Region",
         focus_type=="POC_cat")
# 2021 poc-nonpoc: 29-17=12
# 2011 poc-nonpoc: 30-14=16
# ((12-16)/(16))*100: -25% change

filter <- data_clean %>%
  filter(county=="Region",
         focus_type=="Income_cat")
# 2021 low income: 26
# 2021 non-low income: 20
# 26-20=6
# 2011 low income: 26
# 2011 non-low income: 14
# 26-14=12
# ((6-12)/(12))*100: -50% change

filter <- data_clean %>%
  filter(county=="Region",
         focus_type=="Youth_cat")
# 2021 youth-other: 39-14=25
# 2011 youth-other: 35-10=25
...
# 2011 king:24-14=10
# 2021 king:31-17=14
# ((14-10)/(10))*100: 40% change
# 2011 kitsap:33-15=18
# 2021 kitsap:20-12=8
# ((8-18)/(18))*100: -56% change
# 2011 pierce:29-13=16
# 2021 pierce:24-16=8
# ((8-16)/(16))*100: -50% change
# 2011 snohomish:22-11=11
# 2021 snohomish:28-17=11
# ((11-11)/(11))*100: 0% change
...
1. 150%: The regional gap in overcrowding between people of color and white, non-Hispanic decreased 25% between 2011 and 2021
2. 50%: Overcrowding among renting households in the region who were below 200% of federal poverty line decreased 50% between 2011 and 2021
3. 25: The regional difference in overcrowding rates between households with youth and other households has remained consistent at 25 percentage points between 2011 and 2021

\

#### Insights & Analysis

* The difference in overcrowding for households with people of color and white non-Hispanic has varied across the region over time: increasing in King County (40% increase), remaining the same in Snohomish County, and decreasing in Kitsap County (56% decrease) and Pierce County (50% decrease)
* In King and Snohomish Counties the prevalence of overcrowded households below 200% of federal poverty line leveled off around one-quarter between 2016 and 2021, after an increase between 2011 to 2016. Pierce County experienced a slight decline (2 percentage points) between 2016 and 2021, while Kitsap experienced a slight incline (2 percentage points).
* The difference in overcrowding experienced by people with a disability compared to those without has increased in all counties, except Pierce, between 2016 and 2021
* The difference in overcrowding experienced by households with limited English proficiency compared to English proficient households has decreased in all counties, except Kitsap, between 2016 and 2021
* The largest difference in overcrowding between households with youth (below 18 years old) and those without over the past ten years has occurred in King County (53% increase) followed by Kitsap (44% decrease), Snohomish (29% increase), and Pierce (9% increase)
