...
3. 2%: Average percentage of households in a census tract that are living in an overcrowded home

\

#### Insights & Analysis

* King County has the highest rates of overcrowding (4%), followed by Snohomish and Pierce (2%), and Kitsap (1%)
...
* Households with children (below 18 years old) and households with limited English proficient speakers have the highest rates of overcrowding across all of the equity indicators, regardless of county (about 20%). However, there are the largest disparities between households with youth and without youth (up to 16 percentage point difference)
