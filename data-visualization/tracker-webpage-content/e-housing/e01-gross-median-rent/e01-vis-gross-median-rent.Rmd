...
1. \$1,791: Regional median gross rent
2. \$3,500: Highest median gross rent for census tracts (in King County)
3. \$576: Lowest average gross median rent (in Pierce County)
...
# set folder structure
file_name <- 'e01-gross-median-rent-line'
