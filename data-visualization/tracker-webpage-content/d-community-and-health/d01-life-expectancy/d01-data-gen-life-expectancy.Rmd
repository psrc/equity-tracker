...
# Create dataset
This step is optional depending on the format of the indicator.
```{r}
# indicator data set
df_psrc_data
...
# Finalize data set
This step is included so that the data set and variable of interest and year variable are named in a consistent way for downstream processing. 
```{r}
...
Depending on the indicator, weighting by population may not be necessary, but region and county numbers should be calculated, if possible. If your data set doesn't require weighting, a simple average for the region and counties could be calculated. 
...
data_tract <- as.data.frame(rbind(data_equity_wt_region,
  ...
  rename(variable_value=variable_value_wt,
         county=County.Name) # rename to make sure data is consistent with the supporting functions
