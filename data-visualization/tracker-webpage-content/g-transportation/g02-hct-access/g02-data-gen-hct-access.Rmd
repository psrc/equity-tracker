...
```{r}
# this will require joining each of the years of hct access data (1-year increments) to each of the PUMS equity quintile/tract data
...
# because of the mismatch between years we will take the common years
