...
subtitle = "Distance in miles to high capacity transit (HCT) stations"
source = paste("GTFS (General Transit Feed Specification) 2021 data,", "U.S. Census Bureau, American Community Survey (ACS) 2020 5-Year Public Use Microdata Sample (PUMS)", sep="\n")
