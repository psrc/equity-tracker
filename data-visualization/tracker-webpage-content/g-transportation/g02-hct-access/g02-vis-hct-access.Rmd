...
# set the variable
var_name <- "Distance to High <br> Capacity Transit (miles)"
labels <- sprintf(
...
num_colors = 5
color_rev = FALSE
title = "Distance to High Capacity Transit"
subtitle = "The weighted distance in miles to high capacity transit (HCT) stations in 2021"
source = paste("GTFS (General Transit Feed Specification),", "U.S. Census Bureau, American Community Survey (ACS) 2020 5-Year Public Use Microdata Sample (PUMS)", sep="\n")
...
# set variables
df = dplyr::filter(data_clean, data_year %in% c("2016", "2021"))
