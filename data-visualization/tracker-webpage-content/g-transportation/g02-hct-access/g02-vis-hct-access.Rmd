...
file_names <- list(base_dir = 'Y:/Equity Indicators/tracker-webpage-content',
                   ...
                   map = 'g02-hct-access-map-data',
                   chart = 'g02-hct-access-chart-data',
                   map_name = 'g02-hct-access-map.html',
                   column_chart_name = 'g02-hct-access-column',
                   line_chart_name = 'g02-hct-access-line')
...
# load hct station shapefile for mapping
hct_stations <- read_sf(file.path("Y:/Equity Indicators/access/", year, "all_hct.shp")) %>% 
...
# insert null records ----
standard_base_year <- 2016 # earliest data year
