...
Traffic related deaths and serious injuries per 100,000 by census tract. Understanding where traffic related deaths and serious injuries occur at a higher rate can help us understand which communities are disproportionately impacted. Census tracts are used instead of traffic volume to highlight who in the community are most impacted.
...
# max_value <- 1400 # this value will be the max value in the legend
# 
# # set up palettes
...
max_value_legend<-max(ceiling(log10(data_tract$variable_value)), na.rm=TRUE)

# set up palettes
psrc_purple_plus<-c("#FFFFFF", "#E3C9E3","#AD5CAB", "#630460","#4a0048")
...
data_tract<-data_tract%>%
  mutate(log_est_capped=
           ifelse(data_tract$variable_value>10000,
                round(log10(1+data_tract$variable_value),0),
                log10(1+data_tract$variable_value)))

# set the variable
var_name <- "Traffic Related Deaths and <br> Serious Injuries (per 100,000 people)"
...
tract_map <- leaflet() %>%
  ...
  addLegend_decreasing(pal = psrc_palette,
                       ...
                       bins = 4,
                       decreasing = TRUE,
                       labFormat = labelFormat(transform = function(x) round(x*350, 0))
...
3. 94: number of census tracts with a rate of zero in 2024
...
* There are 94 census tracts in the region with a rate of zero for death and serious injuries. For Kitsap County, 8% of census tracts (5) have a rate of zero, followed by and King county 9% (46), Pierce with 10% (19), and Snohomish with 14% (24) 
...
num_colors = 5
color_rev = FALSE
title = "Traffic Related Deaths and Serious Injuries (per 100,000) by Community"
subtitle = "Number of years a newborn can be expected to live"
...
subtitle = "Rate per 100,000 residents, in 5-year spans between 2014 and 2024"
...
* King and Pierce counties have the largest gap increase between communities with low and high concentrations of people with disabilities between 2019 and 2024 
