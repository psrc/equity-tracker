...
# set the variable
var_name <- "Average % of Tree Canopy <br> 2021"
labels <- sprintf(
...
1. 30%: The region's average tree canopy coverage per census tract in 2021
...
* Kitsap County has the highest average tree canopy cover (44%), followed by Snohomish (32%), King (30%), and Pierce (27%)
...
1. 2x: As a region, communities with low concentrations of households with lower income have almost twice the canopy cover as communities with high concentrations
2. 1.5x: As a region, communities with low concentrations of people of color have about 1.5 times the canopy cover as communities with high concentrations
3. Tree canopy coverage is comparable across communities with differing concentrations of people with a disability
...
*	The counties with the largest gap between low and high concentrations of people of color are Kitsap and Pierce counties
*	The counties with the largest gap between low and high concentrations of households with lower income are Kitsap and King counties
*	The counties with the largest gap between low and high/medium high concentrations of households with limited English proficiency are Kitsap and Snohomish counties
...
# # insert null records ----
# Commented out as it does not seem to add to this scenario where only one year is available vs. multiple years
...
*	The gap in average tree canopy coverage for communities with the highest and lowest concentrations of people of color has stayed consistent at the regional level
*	Kitsap County has seen the largest increase in the gap between the highest and lowest concentrations for people of color between 2011 and 2021
*	King County has reduced the gap between the highest and lowest concentrations for communities with lower income between 2011 and 2021 due to decreased average tree canopy for the communities with the lowest concentration
*	Snohomish County has reduced the gap between the highest and lowest concentrations of communities with lower income between 2011 and 2021 due to an increase in average tree canopy for the communities with high concentrations and a decrease for the communities in the low concentrations
*	Communities with high concentrations of households with adults 65+ experienced an increase in tree canopy percentage across every county in the region
