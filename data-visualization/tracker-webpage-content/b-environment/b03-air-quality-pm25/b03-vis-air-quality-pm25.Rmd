...
-   The tract with the lowest average concentration of fine particle pollution (3.5 $\mu\text{g}/\text{m}^3$) is in the eastern part of the region in unincorporated King County. The tracts with the highest average concentration of fine particle pollution (6.5 $\mu\text{g}/\text{m}^3$) are south and east of Tacoma in Pierce County.
...
subtitle = "Annual average measurements of PM2.5 in micrograms/cubic meter"
