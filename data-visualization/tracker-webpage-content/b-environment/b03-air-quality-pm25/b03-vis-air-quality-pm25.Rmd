...
Fine particles (PM2.5) are microscopic pieces of pollution that can easily enter people's bloodstream and cause breathing and heart problems. Fine particle pollution is especially dangerous for children, the elderly and people with sensitive immune systems. In our region, main sources of fine particle pollution come from wood stoves and fireplaces, backyard burn piles, wildfires, and transportation.

The data shown below represent annual average measurements of PM2.5 particles by volume. Daily measurements from Purple Air sensors, excluding July 3-5 (the Independence Day holiday period) and days with wildfire smoke, are averaged and expanded to cover whole Census tracts. The units of measure are notated as micrograms per cubic meter ($\mu\text{g}/\text{m}^3$). For more information, see the Puget Sound Clean Air Agency's Air Quality Data webpage (https://pscleanair.gov/154/Air-Quality-Data).
...
2.  9.0 $\mu\text{g}/\text{m}^3$: The upper limit considered to be "good" air quality; every tract in the region falls below this threshold
...
-   The tract with the lowest average concentration of fine particle pollution (3.5 $\mu\text{g}/\text{m}^3$) is in the eastern part of the region in unincorporated King County. The tract with the highest average concentration of fine particle pollution (6.5 $\mu\text{g}/\text{m}^3$) is in Puyallup, Pierce County.
-   Higher annual averages of fine particle pollution (6.0 $\mu\text{g}/\text{m}^3$ or greater) are found in almost 10% of tracts in the region (90/919), including communities around Kent, Federal Way, and Tacoma.
...
-   King County communities with high concentrations of people of color, households with limited English proficiency, households with lower income, and households have greater average yearly amounts of fine particle pollution than communities with lower concentrations of the same.
-   Pierce County communities with high concentrations of people of color, households with limited English proficiency, households with lower income, and households with youth have greater average yearly amounts of fine particle pollution than communities with low concentrations of the same groups.
