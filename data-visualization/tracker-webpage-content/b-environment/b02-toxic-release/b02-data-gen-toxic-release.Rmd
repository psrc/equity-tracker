...
toxic_release <- read.csv(file.path(folder_path,"toxic_release_exposure.csv"))
```
\
...
to weight life expectancy for 2010, 2015, 2020 - unnecessary for this indicator
```{r, include=FALSE}
