...
tract_map <- leaflet() %>%
  ...
  addLegend_decreasing(pal = psrc_palette,
                       values = data_tract$estimate, #tract_data_plus_zero
...
tract_map
```
Sources: U.S. Environmental Protection Agency (EPA) Toxics Release Inventory (TRI) 2021 data; U.S. Census Bureau, Geography Division 2020 TIGER/Line Shapefiles
