...
# summary(log(1+data_tract$map_estimate)) # max value: 4.238
max_value <- 4.24 # this value will be the max value in the legend
...
psrc_palette <- leaflet::colorNumeric(palette = psrc_purple_plus,
                                      domain = c(min(log(1+data_tract$map_estimate), na.rm = TRUE), max_value, NA)) # this is the value field
...
tract_map <- leaflet() %>%
  ...
  addPolygons(data=data_tract,
              fillColor =  psrc_palette(log(1+data_tract$map_estimate)),
  ...
  addLegend_decreasing(pal = psrc_palette,
                       values = c(min(log(1+data_tract$map_estimate), na.rm = TRUE), max_value, NA),
                       # values = c(min(data_tract$map_estimate, na.rm = TRUE), 70, NA),
                       labels = c(min(data_tract$map_estimate, na.rm = TRUE), 70, NA),
                       # na.label = "No release",
