...
hist(distrib) #Sturges’ rule is a method for determining the optimal number of bins in a histogram based on the sample size.
h <- hist(distrib) 
...
2. 1/2: Nearly half (48%) of census tracts in the region have no toxic site release
