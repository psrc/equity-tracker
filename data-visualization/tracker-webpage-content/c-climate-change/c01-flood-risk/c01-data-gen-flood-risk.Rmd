...
flood_risk <- read.csv(file.path(folder_path,"first_street_foundation_flood_risk_census_tract.csv"))
```
\
We will be using the a data set that hypothesizes potential flood risk for the forthcoming years of 2022 to 2052. 
