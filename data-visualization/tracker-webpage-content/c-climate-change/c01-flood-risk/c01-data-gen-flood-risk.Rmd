...
# Download data 
## Primary data 
Data comes from [First Street Foundation](https://firststreet.org/data-access/public-access/). Separate CSVs at the census tract geography through FSF's AWS Data Portland and are available (manual download) for 5y time spans at 1y increments, starting in 2000, until 2020.
```{r, include=FALSE}
folder_path <- "Y:/Equity Indicators/tracker-webpage-content/a-regional-health-collaboration/c01-flood-risk/raw-data"
...
to weight exposure of population for 2010, 2015, 2020
```{r, include=FALSE}
