...
data_full$indicator_attribute <-  c("A", "B", "C")
...
if(num_row< 180){
  warning(paste("There are", num_indatt, "rows: ",
              attributes_list, ". Please choose 1."))
} else {
  message("There is only one indicator attribute: ", attributes_list,
              ". No need to filter.")
...
theme_dir <- 'f-economy'
ind_dir <- 'f01-median-income/update'
...
county_reg_data <- county_data %>% 
  mutate(reg_estimate=reg_median$HINCP_median)
