...
labels <- sprintf(
  "Census tract: <em>%s</em><br/><strong>%s</strong><br/><small>%s</small>",
  acs_data_tract$geoid20, # the code in <> makes the geoid value italic
  paste("$", # if doesn't require prefix, this can be removed
        prettyNum((round(acs_data_tract$estimate, digits=-2)),
                  big.mark = ",")),
  paste("Coefficient of variation: ", acs_data_tract$countyfp20)) %>%
