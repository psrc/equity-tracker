...
[Median household income is a broadly recognized indicator of economic well-being. It provides information about the financial resources available to households, and is closely tied to employment levels, educational attainment, and health. For most people, wages earned from work is the primary driver of economic success. The gap between the highest earners and everyone else has been growing in the U.S. for decades. For this measure, median household income is based on the pre-tax income of all household members 15 years and older, where half the households in the geographic area earn more and half earn less, including households with no income.]
...
var_name <- "Household Income <br> (2021 USD)" # the <br> could be adjusted depending on the length/spacing of the name
labels <- sprintf(
...
# 53033005304 (Seattle UW) $21042, 53033005305 (Seattle UW) $26417, 53053061601 (Tacoma) $28359, 53033030501 (Auburn, around 167) $32803
...
* The three census tracts with the lowest median income are Seattle's University of Washington (\$21,000 and \$26,400), downtown Tacoma (\$28,400), and Auburn around Route 167 (\$32,800)
...
# source('C:/Coding/equity-tracker/data-visualization/equity-tracker-chart-functions.R') 
...
source = "U.S. Census Bureau, 2017-2021 American Community Survey 5-Year Public Use Microdata Sample (PUMS)"
...
source = "U.S. Census Bureau, 2007-2011, 2011-2016, 2017-2021 American Community Survey 5-Year Public Use Microdata Sample (PUMS)"
