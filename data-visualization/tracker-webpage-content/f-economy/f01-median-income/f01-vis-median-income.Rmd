...
* For households with lower income, the median household income is lowest in King County (\$22,100), followed by Snohomish and Kitsap (\$23,800), and Pierce (\$25,300).
...
* The differences in median household income between people of color and white non-Hispanic people from 2012 to 2022 has changed across counties: decreasing in King County (decreased 34%) and Snohomish County (decreased 84%), and increasing in Kitsap County (increased 39%) and Pierce County (increased 27%).
...
* The difference in median household income for those with a disability compared to those without between 2012 and 2022 decreased in Kitsap County (-21%) slightly increased in Pierce and Snohomish counties (+10% and +13%, respectively), and increased to a larger extent in King County (+36%), where the disparity increased by \$13,200).
