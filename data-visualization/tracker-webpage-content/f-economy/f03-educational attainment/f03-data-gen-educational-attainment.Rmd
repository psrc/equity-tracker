...
# filter only fields of interest - census tract and population (may need to be adjusted depending on indicator and if you need to run any calculations/transformations)
acs_data <- acs_data %>% 
