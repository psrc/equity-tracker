...
psrc_palette <- leaflet::colorNumeric(palette = psrc_purple_plus,
                                      domain = c(min(acs_data_plus_zero,na.rm = TRUE),100, NA)) #replace 100 with appropriate max value for data set
...
acs_map <- leaflet() %>%
  ...
  addLegend_decreasing(pal = psrc_palette,
                       ...
                       values = c(min(acs_data_plus_zero,na.rm = TRUE),100, NA),
