---
title: "Data Gen: Exploring, Cleaning, Transforming (PUMS/OSPI data)"
...
#   dplyr::select(GEOID, estimate) %>%
#   dplyr::rename(total_pop20=estimate) # don't want to confuse with median income 'estimate' field
```
