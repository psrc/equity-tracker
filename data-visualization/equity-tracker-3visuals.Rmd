...
#                         file=file.path(website_dev_folder, map_name))
```
\
\

#### Data call outs
```{r map calculations, include=FALSE, eval=FALSE}
...
# data_csv <- readr::read_delim(paste0(folder_path,"Life_Expectancy_at_Birth_16_20.csv"), delim = ",")
...
#### Data call outs
```{r column facet calculations, include=FALSE, eval=FALSE}
# calculate call out information
...
```{r output-final-bar-chart, include=FALSE}
...
```{r line facet, include=FALSE}
# Create Facet Line Chart
# trend_chart <- equity_tracker_line_facet(df = data_clean,
#                                          geo = "county_ord",
#                                          x = "data_year",
#                                          y = "fact_value",
#                                          fill = "focus_attribute_ord",
...
# chart <- equity_tracker_line_facet(df = df,
#                                    geo = geo,
#                                    x = x,
#                                    y = y,
#                                    fill = fill,
...
line_chart <- equity_tracker_line_facet(df = data_clean,
                                        geo = geo,
                                        x = "data_year",
                                        y = "fact_value",
                                        fill = "focus_attribute_ord",
...
# chart <- equity_tracker_line_facet(df = data_clean,
#                                    geo = "county_ord",
#                                    x = "data_year",
#                                    y = "fact_value",
#                                    fill = "focus_attribute_ord",
...
```{r output-final-line-chart, include=FALSE}
...
#                                 source = source,
#                                 subtitle = subtitle),
#                   output_file = 'median-income-line.html',
#                   output_dir = file.path(base_dir,ind_dir))
