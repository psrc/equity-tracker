...
# acs_data_plus_zero<-append(0,acs_data_tract$estimate)
# 
...
tract_map <- leaflet() %>%
  ...
  addPolygons(data=data_tract,
              fillColor = psrc_palette(data_tract$estimate), #psrc_palette(acs_data_plus_zero)
              stroke=FALSE, 
              smoothFactor = 0.2,
              fillOpacity = 0.7,
              group = var_name,
  ...
  addLegend_decreasing(pal = psrc_palette,
                       values = data_tract$estimate, #acs_data_plus_zero
