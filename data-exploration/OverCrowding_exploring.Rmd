...
```{r}
facet_by_geography(data_clean_oneplus, "Region", ": Region")
facet_by_geography(data_clean_oneplus, "King", ": King County")
facet_by_geography(data_clean_oneplus, "Kitsap", ": Kitsap County")
facet_by_geography(data_clean_oneplus, "Pierce", ": Pierce County")
facet_by_geography(data_clean_oneplus, "Snohomish", ": Snohomish County")
```
\
\
