...
healthrisk_map %<>% htmlwidgets::prependContent(html_fix)      # Insert into leaflet HTML code

# fix font for map
css_fix <- "body {font-family: Poppins, serif;}"
...
The y-axis scale is consistent for all equity group facets, but it shifts by county.
```{r}
facet_line_by_geography(health_equity_hilo, "Region", ": King County")
...
```{r cleveland_dot_county_quintile}
